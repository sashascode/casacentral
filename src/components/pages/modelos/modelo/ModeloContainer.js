...
const modelos = [
  ...
  {id: 'toro', title: "Cargada de actitud. #FiatToro", title2: 'FIAT TORO', description: "La Pick Up Fiat Toro combina robustez, fuerza y potencia con un diseño y estilo únicos en el segmento. Robusta y elegante, con equipamiento superior en tecnología, confort y seguridad.", thumbnail: [{img: toro_img1, desc: ''}, {img: toro_img2, desc: 'CENTRAL MULTIMEDIA DE 7"'}, {img: toro_img3, desc: 'VOLANTE MULTIFUNCIONAL'}, {img: toro_img4, desc: 'CONTROL DE TRACCIÓN Y ESTABILIDAD'}], header: toroHeader, ficha: [toroFT, "ficha_tec_toro"],},
  {id: 'uno', title: "", title2: 'FIAT UNO', description: "La esencia italiana y el estilo del FIAT Argo se combinan para lograr deportividad y atractivo en este modelo.", thumbnail: [{img: uno_img1, desc: ''}, {img: uno_img2, desc: 'VOLANTE MULTIFUNCION'}, {img: uno_img3, desc: 'PANTALLA LCE TÁCTIL DE 6,2" CON SENSOR DE ESTACIONAMIENTO'}, {img: uno_img4, desc: 'ANDA MUCHO, GASTA POCO'}], header: unoHeader, ficha: [unoFT, "ficha_tec_uno"],},
