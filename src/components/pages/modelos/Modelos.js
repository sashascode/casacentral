...
const volkswagen = [{name: 'taos', icon: Taos, id: 89, marca: 'volkswagen'}, {name: 'amarok', icon: Amarok, id: 400, marca: 'volkswagen'}, {name: 'gol', icon: Gol, id: 401, marca: 'volkswagen'}, {name: 'nivus', icon: Nivus, id: 403, marca: 'volkswagen'}, {name: 'polo', icon: Polo, id: 404, marca: 'volkswagen'}, {name: 'saveiro', icon: Saveiro, id: 405, marca: 'volkswagen'}, {name: 'tcross', icon: Tcross, id: 405, marca: 'volkswagen'}, {name: 'tiguan', icon: Tiguan, id: 406, marca: 'volkswagen'}, {name: 'touareg', icon: Touareg, id: 407, marca: 'volkswagen'}, {name: 'vento', icon: Vento, id: 408, marca: 'volkswagen'}, {name: 'virtus', icon: Virtus, id: 409, marca: 'volkswagen'}];
const renault = [
